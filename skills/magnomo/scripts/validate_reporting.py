#!/usr/bin/env python3
"""Validate Magnomo reporting Markdown artifacts."""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Validate Magnomo reporting artifacts.")
    ...
    if warnings:
        ...
        print("OK: validated Magnomo reporting artifacts")
    return 0
