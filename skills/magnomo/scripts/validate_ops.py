#!/usr/bin/env python3
"""Validate Magnomo ops.yaml delivery metadata."""
...
from magnomo_utils import has_unresolved_template_token, is_iso_date, is_missing, load_yaml_mapping, scan_unresolved_template_tokens, unique
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Validate Magnomo ops.yaml.")
