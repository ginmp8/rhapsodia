#!/usr/bin/env python3
"""Validate all Magnomo golden examples with the canonical local validators."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate every Magnomo golden example with bundled validators.")
    parser.add_argument("--skill-root", default=str(Path(__file__).resolve().parents[1]), help="Path to the Magnomo skill root.")
