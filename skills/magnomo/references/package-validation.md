...
1. Structural package gate: `scripts/validate_skill_package.py --target <skill-root>`.
...
- `validate_skill_package.py` proves required files, frontmatter, references, templates, scenario schema, and scaffold-marker hygiene.
- `validate_activation_scenarios.py` proves scenario-file schema, category coverage, activation labels, and boundary coverage; it does not prove measured assistant behavior.
