...
When Magia `implementation-adr.md`, `implementation-notes.md`, or `validation-evidence.md` exists, cite it only to show execution reality, residual delivery risk, or release readiness evidence. Do not convert it into governance approval or a technical decision owned by Magnomo.
