...
- [scripts/build_evolution_contract.py](scripts/build_evolution_contract.py): compiles canonical Booster pre-evolution artifacts into the Skill Evolution v4 search contract without leaking Booster-internal schemas into the search controller.
