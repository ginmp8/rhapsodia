...
Use `governance-decision` only for nomia governance decisions. `governance-decisions.md` is a governance decision filename, not an Architecture Decision Record.
