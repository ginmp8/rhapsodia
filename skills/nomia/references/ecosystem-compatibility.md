...
Nomia, Mago, and Magia participate in coordinated exact ecosystem release `1.9.0`. Each package remains independently executable and carries local byte-equivalent copies of shared contracts. Runtime imports, script execution, or file reads from peer skill packages are forbidden.

## Policy

- Package versions must all equal `1.9.0`.
