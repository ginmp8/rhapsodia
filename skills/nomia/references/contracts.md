...
Handoff direction is explicit: nomia hands governance facts to Mago; Mago hands execution-ready planning contracts to Magia; Magia returns execution evidence to Mago for technical replanning gaps and to nomia as read-only input for delivery reporting.
