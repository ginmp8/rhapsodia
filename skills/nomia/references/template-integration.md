...
Use when choosing, scaffolding, auditing, or normalizing a template-backed nomia artifact.
...
- General artifacts: `scripts/write_artifact_scaffold.py <path> [--spec-id spec-YYYY-MM-DD-feature-key--ULID]`.
- Ops: `scripts/write_ops_scaffold.py <path> --spec-id spec-YYYY-MM-DD-feature-key--ULID`.
