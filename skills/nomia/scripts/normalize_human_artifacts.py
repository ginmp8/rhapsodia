#!/usr/bin/env python3
"""Normalize nomia human artifacts without inventing content."""
...
def normalize_yaml(path: Path, check: bool) -> bool:
    if yaml is None:
        raise RuntimeError("PyYAML is required to normalize nomia YAML artifacts.")
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Normalize nomia artifacts without inventing content.")
