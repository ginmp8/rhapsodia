#!/usr/bin/env python3
"""Append a material nomia governance decision entry without rewriting history."""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Append a material nomia governance decision to governance-decisions.md.")
