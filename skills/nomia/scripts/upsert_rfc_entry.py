#!/usr/bin/env python3
"""Create or update a nomia RFC proposal entry by stable proposal id."""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Create or update a nomia RFC proposal in rfc-proposals.md.")
