#!/usr/bin/env python3
"""Validate nomia reporting Markdown artifacts."""
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Validate nomia reporting artifacts.")
    ...
    if warnings:
        ...
        print("OK: validated nomia reporting artifacts")
    return 0
