#!/usr/bin/env python3
"""Normalize Magiarca human artifacts without inventing content."""
...
from magiarca_utils import compact_yaml_exception, unique
...
def normalize_yaml(path: Path, check: bool) -> bool:
    if yaml is None:
        raise RuntimeError("PyYAML is required to normalize Magiarca YAML artifacts.")
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Normalize Magiarca artifacts without inventing content.")
