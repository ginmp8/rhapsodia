#!/usr/bin/env python3
"""Validate and package the Magiarca skill as an installable skill.zip."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate and package Magiarca as skill.zip.")
    parser.add_argument("--target", default=str(Path(__file__).resolve().parents[1]), help="Path to the Magiarca skill root.")
