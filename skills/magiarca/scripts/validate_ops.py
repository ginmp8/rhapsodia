#!/usr/bin/env python3
"""Validate Magiarca ops.yaml delivery metadata."""
...
from magiarca_utils import has_unresolved_template_token, is_iso_date, is_missing, load_yaml_mapping, scan_unresolved_template_tokens, unique
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Validate Magiarca ops.yaml.")
