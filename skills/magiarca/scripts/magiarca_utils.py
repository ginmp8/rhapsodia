#!/usr/bin/env python3
"""Shared helpers for Magiarca validation scripts."""
...
def load_yaml_mapping(path: Path, requirement: str = "PyYAML is required to validate Magiarca YAML artifacts.") -> dict[str, Any]:
    if yaml is None:
...
def main() -> int:
    ...
    print("magiarca_utils.py is an import-only helper for Magiarca validators and scaffold scripts.")
    return 0
