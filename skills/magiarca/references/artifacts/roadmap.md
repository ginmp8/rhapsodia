...
Roadmap artifacts belong to Magiarca. Mago may consume them as upstream evidence, but they do not replace `spec-catalog.yaml`, `prd.md`, or Mago-owned planning artifacts.
...
Machine-readable handoff map from Magiarca roadmap features to candidate Mago specs. Use only as upstream evidence for Mago, never as a generated task plan.
