...
Use only for Magiarca governance handoff from roadmap to Mago. Magiarca prepares handoff facts; Mago owns the planning package and technical decomposition.
...
Mago may return planning blockers, missing evidence, or technical questions. Magia may return execution evidence, technical gap notes, validation gaps, and delivery-impact signals. Magiarca may record these as governance blockers, delivery risks, handoff facts, or reporting evidence, but must not edit the underlying Mago/Magia technical artifacts or treat returned evidence as Magiarca technical validation.
