...
Reporting starts after delivery activity has evidence. It turns Magiarca metadata and supplied delivery evidence into human-ready communication without inventing facts.

Reporting consumes Magia execution evidence and Mago planning evidence as source material. Attribute technical statements to their source and keep Magiarca authority limited to delivery communication, governance status, and stakeholder-readable summaries.
...
Do not claim shipment without explicit release, deployment, or rollout evidence. Do not claim technical validation, production readiness, or test completion unless the supplied evidence says so; phrase it as sourced evidence, not Magiarca validation. Mark missing release, rollout, or validation evidence as unknown/draft/pending/not recorded. Do not expose internal-only details in `release-notes.md`; place them in `internal-notes.md`. Never include secrets, credentials, private tokens, or raw sensitive operational data.
