...
Use `governance-decision` only for Magiarca governance decisions. `governance-decisions.md` is a governance decision filename, not an Architecture Decision Record.
