# Magiarca Golden Examples

These examples demonstrate intended Magiarca patterns without turning governance artifacts into Mago execution-handoff plans or Magia execution evidence.

## Directory Structure

```text
.github/skills/magiarca/examples/golden/
|- index.md
...
6. Roadmap-to-spec handoff for Mago: hand off a ready feature as upstream evidence for Mago while keeping Magiarca ownership clear.
...
- Branches, pull requests, commits, checks, review status, deployment state, and last commit age are not maintained as Magiarca source-of-truth fields.
...
- Execution evidence is consumed as input evidence; Magiarca does not rewrite it.
