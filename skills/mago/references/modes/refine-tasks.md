...
4. Open `references/artifacts/templates-and-status.md` for the canonical tasks.md contract. Open references/specialist-spellbook.md for task specialist metadata, references/markdown-writing.md for Markdown edits, and use local scripts for template-backed writes, normalization, and validation whenever tasks.md needs template reconciliation.
