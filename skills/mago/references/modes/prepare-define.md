...
4. Create or reconcile the selected package path under `BOARD_ROOT/specs/<spec_id>/` from [../canonical-paths.md](references/canonical-paths.md) conservatively so the result is compatible with the later downstream mode.
