...
Before governed handoff, `notes.md` uses clarification contract v2 and no open blocker or open high/critical assumption/question may remain. Validate with `scripts/validate_clarification_readiness.py --require-v2 --handoff`.
