...
SHARED_REQUIRED = (
    "references/ecosystem-reproducibility-contract.json",
    "references/ecosystem-ownership-contract.json",
    "references/ecosystem-migration.md",
    "evals/ecosystem-cross-skill-scenarios.json",
    "scripts/validate_ecosystem_reproducibility.py",
    "scripts/create_package_receipt.py",
    "tests/test_ecosystem_reproducibility.py",
