...
- Compatibility impact: compatible coordinated minor; Mago remains technical-planning only, handoff schema remains `3.0.0`, priority schema remains `2.0.0`, and exact-version policy requires all three 1.10.0 packages together.
