...
- Reject unsupported envelope schemas, legacy compatibility switches, malformed provenance, and mixed ecosystem versions before mutation or handoff consumption.
...
- skill/package integrity: `scripts/validate_release_metadata.py`, `scripts/validate_contract_semantics.py`, `scripts/run_sdd_evidence_harness.py`, `scripts/merge_evidence_reports.py`, `scripts/validate_skill_package.py`, and `scripts/validate_distribution.py`; package only after all gates pass.
