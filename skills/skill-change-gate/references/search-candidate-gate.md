...
The v2 input contract is declared in `contracts/integration-manifest.json`. This gate still owns only candidate-local acceptance; it must not absorb population selection or peer orchestration.
