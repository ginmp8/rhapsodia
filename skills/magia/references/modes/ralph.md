...
2. Load board spec catalog; selected manifest, PRD, tasks, validation.md as validation plan, notes.md as planning context, implementation-notes.md and validation-evidence.md when present; technical design when present and needed; only relevant auxiliary docs/source refs/tests/repo files.
