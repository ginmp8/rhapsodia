...
| Artifact | MAGO/Magnomo ownership | MAGIA authority | Rules |
|---|---|---|---|
...
| `spec-catalog.yaml` | MAGO catalog and planning order; Magnomo delivery status is separate | execution-state sync only | Sync only technical execution status. Do not set delivery/governance/release status. |

Downstream evidence boundary: Magnomo may read MAGIA-owned evidence for feature reports, release notes, governance blockers, or delivery risk. MAGIA must keep the evidence factual and source-level; Magnomo owns the stakeholder-facing interpretation.
...
- Hand off to Magnomo for delivery commitments, release posture, stakeholder communications, roadmap status, owner, or accepted business risk.
- Do not create governance RFCs, release notes, portfolio reports, stakeholder briefs, roadmap updates, or delivery status records; write execution evidence that Magnomo can consume instead.
