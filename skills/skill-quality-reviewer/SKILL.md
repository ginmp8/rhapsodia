...
14. **Review evidence and validation.** Separate executed checks from planned scenarios. Check whether validators actually test claimed properties, whether old formats are explicitly rejected, and whether evidence can be mutated by the workflow being evaluated.
