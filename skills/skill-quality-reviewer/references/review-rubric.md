...
Do not award or deduct points solely because the candidate has more/fewer files, scripts, modes, references, or tokens. Connect each material delta to a reachable behavior, contract, consumer, validator, or explicitly declared capability.
